...
namespace FleetFlow.Service.Interfaces.Warehouses
{
    public interface IProductInventoryAssignmentService
    {
        ...
        Task<ProductInventoryAssignmentForResultDto> RemoveQuantity(long Id, int amount);
        Task<ProductInventoryAssignmentForResultDto> AddQuantity(long Id, int amount);
    }
}
