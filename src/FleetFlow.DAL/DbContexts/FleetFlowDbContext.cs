    ...
    public class FleetFlowDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User() { Id = 1, FirstName = "Mukhammadkarim", LastName = "Tukhtaboyev", Email = "dotnetgo@icloud.com", Phone = "+998 991239999", Role = UserRole.Admin, PasswordHash = "12345678", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 2, FirstName = "Jamshid", LastName = "Ma'ruf", Email = "wonderboy1w3@gmail.com", Phone = "+998 991231999", Role = UserRole.User, PasswordHash = "124tBghM_78", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 3, FirstName = "Kabeer", LastName = "Solutions", Email = "kabeersolutions@gmail.com", Phone = "+998 991232999", Role = UserRole.Packer, PasswordHash = "4tBghM_78", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 4, FirstName = "Muzaffar", LastName = "Nurillayev", Email = "nurillaewmuzaffar@gmail.com", Phone = "+998 995030110", Role = UserRole.Admin, PasswordHash = "15tBghM678", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 5, FirstName = "Azim", LastName = "Ochilov", Email = "azimochilov@icloud.com", Phone = "+998 991233999", Role = UserRole.Merchant, PasswordHash = "14tBghM_2345678", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 6, FirstName = "Abdulloh", LastName = "Ahmadjonov", Email = "abdulloh@icloud.com", Phone = "+998 991236999", Role = UserRole.User, PasswordHash = "1tBghM5678", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 7, FirstName = "Komron", LastName = "Rahmonov", Email = "komron2052@gmail.com", Phone = "+998 991234999", Role = UserRole.Picker, PasswordHash = "1234tBghM_", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 8, FirstName = "Nozimjon", LastName = "Usmonaliyev", Email = "nozimjon@gmail.com", Phone = "+998 991235999", Role = UserRole.Driver, PasswordHash = "1234tBghM_78", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 9, FirstName = "AlJavhar", LastName = "Boyaliyev", Email = "aljavhar@gmail.com", Phone = "+998 902344545", Role = UserRole.Admin, PasswordHash = "15tBghM678", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
                new User() { Id = 10, FirstName = "Muhammad", LastName = "Rahimboyev", Email = "muhammad@gmail.com", Phone = "+998 937770202", Role = UserRole.Admin, PasswordHash = "15tBghM678", CreatedAt = DateTime.UtcNow, UpdatedAt = null}
                );
